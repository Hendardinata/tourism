...
<head>
    ...
    <!-- Website Title -->
    <title>Tourim Landing Page</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-container">
                            <h1>TOURISM <span id="js-rotating">LOVELINESS, BEAUTY, ELEGANCCE</span></h1>
                            <p class="p-heading p-large">
                                Pulau Lombok is a paradise for nature lovers and travelers, boasting stunning beaches. Kuta Lombok Beach stands out with its flour-like white sand and crystal-clear turquoise waters, while the surrounding green hills add to the natural charm, creating an enchanting scenery.</p>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="text-container">
                        ...
                        <h2>We Offer Some Of The Best Tourism Services In Town</h2>
                        <p>
                            Launching a new travel agency or enhancing the market position of an existing one can be quite an overwhelming process at times.</p>
                        <p class="testimonial-text">"Discovering the beauty of Lombok Island is akin to uncovering a hidden treasure trove, with its mesmerizing beaches, lush landscapes, and captivating cultural heritage."</p>
                        <div class="testimonial-author">Hendar Dinata - CEO</div>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-lg-7">
                    <div class="image-container">
                        <img class="img-fluid" src="images/hensV.jpg" alt="alternative">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2>Choose the destination<br> that you like.</h2>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card detail">
                        <div class="card-image">
                            <img style="height: 250px" class="img-fluid" src="{{asset('storage/image-destination/'.$d->image) }}" alt="alternative">
                        </div>
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled li-space-lg">
                                <li class="media">
                                    ...
                                    <div class="media-body">Status <span>{{ $d->status }}</span></div>
                                </li>
                            </ul>
                            <p class="price">Starting at Rp. <span>{{ $d->price }}</span></p>
                        </div>
                        <div class="element-item design marketing button-container">
                            {{-- <a class="btn-solid-re popup-with-move-anim" href="#lb-s"><div class="element-item-overlay"><span>Zazoo Apps</span></div></a> --}}
                            <a class="btn-solid-reg popup-with-move-anim" href="#lb-s{{$d->id}}">DETAILS</a>
                        </div>
                        {{-- <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="#lb-s">DETAILS</a>
                        </div> <!-- end of button-container --> --}}

                    <!-- Lightbox Services-->
                    <div id="lb-s{{$d->id}}" class="lightbox-basic zoom-anim-dialog mfp-hide">
                        <div class="row">
                            {{-- @foreach($data as $d) --}}
                            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
                            <div class="col-lg-8">

                                <img class="img-fluid" src="{{asset('storage/image-destination/'.$d->image) }}" alt="alternative">
                            </div> <!-- end of col -->
                            <div class="col-lg-4">
                                <h3>{{ $d->title }}</h3>
                                <hr class="line-heading">
                                <h6>Strategy Tourism</h6>
                                {{-- <p>{{ $d->content }}</p> --}}
                                <div class="testimonial-container">
                                    <p class="testimonial-text">{{ $d->content }}</p>
                                    <p class="testimonial-author">Enjoy your meal</p>
                                </div>
                                <h6>Ticket Rp. {{ $d->price }}</h6>

                                {{-- <a class="btn-solid-reg" href="{{ route('book.ticket', $d->id) }}">Book Ticket</a> --}}
                                <!-- Jika pengguna sudah login, tampilkan tombol Book Ticket -->
                                @auth
                                    <a class="btn-solid-reg" href="{{ route('book.ticket', $d->id) }}">Book Ticket</a>
                                @else
                                    <!-- Jika pengguna belum login, arahkan mereka ke halaman login -->
                                    <a class="btn-solid-reg" href="{{ route('login') }}">Book Ticket</a>
                                @endauth
                                <a class="btn-outline-reg mfp-close as-button">Maps</a>
                                ...
                                <div class="mt-5">
                                    <ul class="list-unstyled pt-20">
                                        <li>
                                            {{-- <strong>Rating : {{ isset($d->averageRating) ? number_format($d->averageRating, 2) : 'Data tidak tersedia' }}</strong> --}}
                                            <strong>Rating: {!! isset($d->averageRating) ? number_format($d->averageRating, 2) . ' <span class="star-rating">&#9733;</span>' : 'Data tidak tersedia' !!}</strong>
                                        </li>
                                ...
                                @auth
                                <h4>Add a Rating</h4>
                                <form action="{{ route('destinations.storeRating', $d) }}" method="POST">
                                    @csrf
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="address"><i class="fas fa-map-marker-alt"></i>Mataram, Nusa Tenggara Barat.</li>
                            <li><i class="fas fa-phone"></i><a href="tel:003024630820">+62 8199 482 611</a></li>
                            <li><i class="fas fa-envelope"></i><a href="mailto:office@aria.com">muhammadhifzil19@gmail.com</a></li>
                        </ul>
                        <h3>Follow Tourism On Social Media</h3>
